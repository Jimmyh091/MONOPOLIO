...
public class PantallaPrincipal extends PanelBase{
    ...
    protected PantallaPrincipal(JFrame v, AdministradorPaneles a){
        ...
        try {
            imagenTitulo = ImageIO.read(getClass().getResourceAsStream("/elementos/imagenes/pantallaPrincipal/titulo.png"));
            imagenBotonSinHover = ImageIO.read(getClass().getResourceAsStream("/elementos/imagenes/pantallaPrincipal/boton.jpg"));
            imagenBotonConHover = ImageIO.read(getClass().getResourceAsStream("/elementos/imagenes/pantallaPrincipal/botonHover.jpg"));
