...
public class FakeGamePanel extends JPanel implements Runnable{ //a ABANDONADA
    ...
    protected FakeGamePanel(){
        ...
        //titleScreenButtons[0] = new MButton("button", 10, 100, 40, 0, true, "Hola", 20, (BufferedImage) null, null, null);
        //titleScreenButtons[1] = new MButton("otherbutton", 120, 100, 40, 0, true, "Hola", 20, (BufferedImage) null, null, null);
                
        //gameScreenButtons[0] = new MButton("otherotherbutton", 10, 100, 40, 0, true, "Tirar", 20, (BufferedImage) null, null, null);
